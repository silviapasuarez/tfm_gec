...
# -*- coding: utf-8 -*-
"""
Fine-tuning de Salamandra-7B-Instruct (ChatML) para corrección gramatical en galego
Dataset A: usa 'explanation' en lugar de 'changes'.
...
DATASET_PATH = "/workspace/dataset_a.jsonl"
OUTPUT_DIR   = "/workspace/corrector_salamandra_stage1_A"

TRAIN_PHASE  = "stage1"   # "stage1" -> pérdida solo en respuesta, "stage2" -> pérdida completa
SEED         = 3407
...
def _build_io(example: dict) -> dict:
    ...
    if explanation:
        output_txt += explanation
    else:
        output_txt += "(sen explicación dispoñible)"
